...
Gem::Specification.new do |s|
  ...
  s.summary = %q{Debug, Track and benchmark methods.}
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<wrap_method>, [">= 0"])
      s.add_runtime_dependency(%q<cobalt>, [">= 0"])
      ...
      s.add_dependency(%q<wrap_method>, [">= 0"])
      s.add_dependency(%q<cobalt>, [">= 0"])
